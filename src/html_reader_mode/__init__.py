...
class HTMLReaderMode:
    ...
    def __init__(
        ...
        script_tags: set[str] | None = None,
        terminating_keywords: list[str] | None = None,
        cutoff_keywords: list[str] | None = None,
    ):
        ...
        Args:
            ...
            block_tags (set[str] | None): set of block HTML tags
            script_tags (set[str] | None): set of script HTML tags
            terminating_keywords (list[str] | None): list of terminating keywords
            cutoff_keywords (list[str] | None): list of cutoff keywords
        """
    ...
    def _classify_blocks(self, blocks: list[TextBlock]) -> None:
        ...
        for i in range(len(blocks)):
            prev: TextBlock | None = blocks[i - 1] if i > 0 else None
